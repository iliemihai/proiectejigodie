...
void* StackAllocator::Allocate(const std::size_t size, const std::size_t allignment) {
	const std::size_t currentAddress = (std::size_t)m_start_ptr+m_offset;
	std::size_t padding = Utils::CalculatePaddingWithHeader(currentAddress, allignment, sizeof(AllocationHeader));
